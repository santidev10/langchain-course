...
def run_agent(question: str):
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        if tool_name not in tools:
            ...
            observation = str(tools[tool_name](*args))    # This is the function call to the tool. LLM's can only handle string inputs, so we convert the result to a string for the next LLM call.
